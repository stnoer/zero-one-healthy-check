...
uint64_t AddRefValueService::saveData(const AddRefValueDTO::Wrapper& dto)
{
	...
	ZO_STAR_DOMAIN_DTO_TO_DO(data, dto,
		BaseProjectId, base_project_id, AllowSex, allow_sex, MinAge, min_age, MaxAge, max_age, 
		HealthyValue, healthy_value, OccupationValue, occupation_value, DepartmentId, department_id,
